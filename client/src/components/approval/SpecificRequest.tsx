            ...
            {specificRequest?.approver_response === "Pending" ? (
              ...
              <div>
                {specificRequest?.approver_response === "Approved" ? (
                  <div className="text-green-500 gap-2 text-[16px] flex items-center">
                    <CheckCircle size={20} />
                    Approve
                  </div>
                ) : (
                  <div className="text-red-500 gap-1 text-[16px] flex items-center">
                    <XCircle size={20} />
                    Rejected
                  </div>
                )}
          ...
          <div className="mb-6 max-w-[450px]">
            ...
            <div className="bg-gray-100 p-4 rounded-md flex items-center gap-4">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <p className="font-medium">{specificRequest?.doc_name}</p>
                </div>
              </div>
              <button
