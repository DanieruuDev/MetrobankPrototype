    ...
    <aside>
      ...
      >
        ...
        <ul className="mt-3 text-white p-5 font-semibold">
          <li
            className={`mb-2 ml-0.5 rounded hover:shadow relative hover:bg-white hover:text-blue-700 py-2 flex items-center group ${
      ...
      `}
          ...
          {!sidebarToggle && isFinancialSet && (
            <ul className="ml-5 mt-2 p-2 font-semibold">
              <li className="mb-2 py-3 hover:bg-white hover:text-blue-700 rounded pl-2 flex gap-2 items-center">
                <FileUser size={32} />
                <a href="/financialpage/financialpage ">Financial</a>
              </li>
              <li className="mb-2 py-3 hover:bg-white hover:text-blue-700 rounded pl-2 flex gap-2 items-center">
                <FileUser size={32} />
                <a href="/financialpage/approvalpage">Approvals</a>
              </li>
              <li className="mb-2 py-3 hover:bg-white hover:text-blue-700 rounded pl-2 flex gap-2 items-center">
                <FileUser size={32} />
                <a href="/financialpage/analyticspage">Analytics</a>
              </li>
              <li className="mb-2 py-3 hover:bg-white hover:text-blue-700 rounded pl-2 flex gap-2 items-center">
                <FileUser size={32} />
                <a href="/financialpage/managementpage">Management</a>
              </li>
            </ul>
          )}
          <li
            className={`mb-2 rounded hover:shadow relative hover:bg-white hover:text-blue-700 py-2 flex items-center group ${
              sidebarToggle ? "justify-end mb-7" : ""
            }`}
          >
            <svg
